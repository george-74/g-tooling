...
def migrate_v1_to_v2(conn: sqlite3.Connection) -> None:
    ...
    conn.executescript("""
        ...
        INSERT INTO tools_v2 (id, number, name, diameter, color, can_plunge, active,
            ...
            flutes_coating, flutes_type, shank, max_depth, depth_per_pass, extras, updated_at)
        SELECT id, number, name, diameter, color, can_plunge, active,
            ...
            COALESCE(max_depth, 0), COALESCE(depth_per_pass, 0),
            extras, updated_at
        FROM tools;
        ...
        with db_connect() as conn:
            ...
            try:
                ...
                for key in ["number", "name", "diameter", "color", "can_plunge", "active",
                            ...
                            "shank", "max_depth", "depth_per_pass", "extras"]:
